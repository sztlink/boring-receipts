...
set "OUT=C:\Users\user\boring\kvdtype-source-build-v8-b9286-vs2019-pdlpatch-20260523\bench-longctx-20260523"
...
for %%V in (f16-f16 q8_0-q8_0 q8_0-q4_0) do (
  ...
  "%BIN%\llama-bench.exe" -m "%MODEL%" -ngl 99 -fa 1 -ctk !CTK! -ctv !CTV! -p 512 -n 128 -d 0,4096,16384,32768,65536 -r 2 -o jsonl > "%OUT%\%%V.jsonl" 2>> "%OUT%\%%V.stderr.txt"
