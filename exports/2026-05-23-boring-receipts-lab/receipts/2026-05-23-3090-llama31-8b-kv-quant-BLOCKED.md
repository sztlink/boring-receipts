...
- It does not prove that KV-cache quantization is broken in general; it proves this command shape blocks on the stated llama.cpp prebuilt, CUDA stack and AYA-3090 node.
- It does not compare source builds, other drivers, other GPUs or other runtimes.
- It does not provide a throughput delta for KV quantization, because the command did not complete. The blocker is the receipt.
